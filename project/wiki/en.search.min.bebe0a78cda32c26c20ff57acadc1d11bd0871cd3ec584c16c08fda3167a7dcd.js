...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/project/wiki/flexsearch.min.js');loadScript('/project/wiki/en.search-data.min.3a4da9d57ded7d91f710e530fc894b31f64ffe1a53e0c3dc1c8aa505e1b3844f.js',function(){input.required=false;search();});}
