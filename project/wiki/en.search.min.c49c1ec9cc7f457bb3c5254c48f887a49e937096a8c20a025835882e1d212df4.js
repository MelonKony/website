...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/project/wiki/flexsearch.min.js');loadScript('/project/wiki/en.search-data.min.4af6d5bbb84fd1075e6accc1207634c45cc6cb61e20ffead76afefe9ef5ae711.js',function(){input.required=false;search();});}
